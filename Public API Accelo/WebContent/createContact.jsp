...
<%@ page import="com.accelo.api.action.ContactsAction"%>
...
<body>
<h1 align = "center">Contact Creation</h1>
<s:form action="createContact">
<table align = "center">
<tr>
	<td>
...
<tr>
	<td align="right"><s:submit value="Create Contact"></s:submit> </td>
</tr>
<tr>
